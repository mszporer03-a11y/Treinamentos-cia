...
import { BookOpen, LogOut, ChevronDown, UserCircle2, MessageSquare, GalleryHorizontalEnd, GraduationCap, FileText, Menu, X, BarChart2, ClipboardList } from "lucide-react";
